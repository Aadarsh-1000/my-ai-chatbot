...
window.onload = function () {
    ...
    // RENDERS THE FALLBACK BUTTON: This guarantees users can log in even if One Tap is blocked!
    google.accounts.id.renderButton(
        document.getElementById("googlelogin"),
        { theme: "outline", size: "large", text: "signin_with" }
    );

    // Prompt One Tap only if the user is not logged in
    if (!user) {
...
// Retained for backwards compatibility, but the button handles clicks natively now
function Login() {
